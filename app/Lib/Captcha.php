...
class Captcha
{
    public function create()
    {
        ...
        $font1 = 'fonts/captcha/' . rand(1, 5) . '.ttf';
        $font2 = 'fonts/captcha/' . rand(1, 5) . '.ttf';
        $font3 = 'fonts/captcha/' . rand(1, 5) . '.ttf';
        $font4 = 'fonts/captcha/' . rand(1, 5) . '.ttf';
        $font5 = 'fonts/captcha/' . rand(1, 5) . '.ttf';
