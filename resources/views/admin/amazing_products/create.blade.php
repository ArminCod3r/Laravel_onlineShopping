...
@section('header')
	<title>افزودن محصولات شگفت انگیز</title>
@endsection

@section('custom-title')
  افزودن محصولات شگفت انگیز
@endsection
...
<form action="{{ action('admin\AmazingProductController@store') }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label for="time_amazing">مدت زمان شگفت انگیز بودن</label>
  		<input type="text" name="time_amazing" id="time_amazing" class="form-control" placeholder="بر حسب ساعت">
