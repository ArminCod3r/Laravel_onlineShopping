			...
			<table class="table table-bordered">
				<tbody>
					...
					<tr>
						<td>
							<span>استان: </span>
							<span> {{ $user_address[0]['state']->name }} </span>
						</td>

						<td rowspan="2">
							<div>
								<span> آدرس:  </span>
								<span> {{ $user_address[0]->address }} </span>
							</div>
							<div>
								<span> کد پستی: </span>
								<span> {{ $user_address[0]->postalCode }} </span>
							</div>
						</td>

						<td style="width:30%">
							<span>شماره موبایل:</span>
							<span>{{ $user_address[0]->mobile }}</span>
						</td>
					...
					<tr>
						...
						<td>
							<span>شهر: </span>
							<span> {{ $user_address[0]['city']->name }} </span>
						</td>

						<td>
							<span>تلفن ثابت:</span>
							<span> {{ $user_address[0]->telephone }}-{{ $user_address[0]->city_code }} </span>
						</td>
